...
<body>
    <form id="form1" runat="server">
        ...
        <div class="row">
            <div class="col-md-4"><asp:Image runat="server" ID="Image3" ImageUrl="~/Images/p4.jpeg"
    Width="296px" Height="150px" CssClass="img fluid" /></div>
        </div>
        <table class="w-100">
            <tr>
 ...
 <td class="auto-style7">Category</td>
            ...
            <tr>
                ...
                <td class="auto-style15">
                    <asp:TextBox ID="PrdDes" runat="server" Height="84px" Width="290px" TextMode="MultiLine"></asp:TextBox>
                </td>
